...
export class JobExecutionService {
  ...
  private async createExecutionRecord(tenantId: string, job: any, technicianId: string, summary?: string | null) {
    const db = this.prisma as any;
  ...
  private async resolveEditableRecord(tenantId: string, job: any, technicianId: string, summary?: string | null) {
    const latest = await this.getLatestRecord(tenantId, job.id);
