...
export const WHEELS_TEMPLATE_FIELDS: WheelsTemplateField[] = [
  ...
  { key: "siteLocation", label: "Site Location", type: "text", group: "Job Details" },
  ...
  { key: "vehicleColour", label: "Vehicle Colour", type: "text", group: "Technician & Vehicle" },
  ...
  { key: "customerNotes", label: "Customer / Job Notes", type: "textarea", group: "Wheel & Service" },
  { key: "internalNotes", label: "Internal Notes", type: "textarea", group: "Wheel & Service" },
  ...
  { key: "additionalServicesText", label: "Additional Services", type: "textarea", group: "Pricing" },
  { key: "additionalServicePrice", label: "Additional Service Price", type: "number", group: "Pricing" },
