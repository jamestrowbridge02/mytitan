...
export default function IndustriesPage() {
  return (
    <MarketingShell>
      ...
      <MarketingPageHero
        eyebrow="Industries"
        title="Built for service businesses that need real operating discipline."
        lead="MyTitan is positioned for teams where workflow drift, dispatch pressure, customer follow-through, and governance gaps have real operational cost."
        actions={
          <>
      ...
      <section className="mkt-section">
        <MarketingSectionHeading
          eyebrow="Segments"
          title="A fit for serious service operators, not lightweight field apps."
      ...
      <section className="mkt-section">
        <div className="mkt-proof">
          ...
          <p>
            MyTitan can support a smaller operator today, then extend into broader command-centre oversight, recurring service delivery,
      ...
      <MarketingCtaBand
        ...
        copy="Use a demo to walk through the modules that matter most for your segment, then evaluate how the broader platform closes the rest of the gaps."
