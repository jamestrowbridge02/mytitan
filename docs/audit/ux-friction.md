...
## Positive Notes
- `DashboardShell` centralizes tenant branding, location context, notifications access, and demo banners.
- Demo and guided setup overlays/checklists are in place and linked to real screens.
