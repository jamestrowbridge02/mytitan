...
export default function NewJobPage() {
  ...
  async function submitWheels(e: React.FormEvent) {
    ...
    const guidedBeforePhotos = guidedExperienceEnabled
      ? await Promise.all(
    ...
    const guidedAfterPhotos = guidedExperienceEnabled
      ? await Promise.all(
    ...
    const torqueEvidencePhoto = guidedExperienceEnabled && torqueFile
      ? {
    ...
    const payloadForm = {
      ...
      beforePhotos: guidedBeforePhotos,
      afterPhotos: guidedAfterPhotos,
      torqueEvidencePhoto,
