import { Controller, Get, HttpException, HttpStatus, Post, Query, Res, UseGuards } from '@nestjs/common';
...
export class IntegrationsController {
  ...
  @Post('xero/connect')
  @Roles('OWNER', 'ADMIN')
  connectXero(@CurrentUser() user: JwtPayload) {
  ...
  @Post('qbo/connect')
  @Roles('OWNER', 'ADMIN')
  connectQbo(@CurrentUser() user: JwtPayload) {
    requireMarketplaceEnabled();
  ...
  @Post('google/connect')
  @Roles('OWNER', 'ADMIN')
  connectGoogle(@CurrentUser() user: JwtPayload) {
    requireMarketplaceEnabled();
