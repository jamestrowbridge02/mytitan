...
import { isCommandCentreEnabled, isCommandCentreV1Enabled, isDemoTourV1Enabled, isGuidedEverywhereV1Enabled, isGuidedSetupV2Enabled } from '../../lib/feature-flags';
...
export default function Dashboard() {
  ...
  }, [router, router.isReady, settings?.guidedSetupCompletedAt, commandCentreV1Enabled]);
      ...
      {guidedEverywhereEnabled ? (
        <div className="card" style={{ marginBottom: 16 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(180px,1fr))', gap: 10 }}>
            <a className="button secondary" href="/dashboard/guided?action=create_job">Create job</a>
            <a className="button secondary" href="/dashboard/guided?action=book_appointment">Book appointment</a>
            <a className="button secondary" href="/dashboard/guided?action=take_payment">Take payment</a>
            <a className="button secondary" href="/dashboard/guided?action=order_parts">Order parts</a>
            <a className="button secondary" href="/dashboard/guided?action=message_customer">Message customer</a>
          </div>
        </div>
      ) : null}
