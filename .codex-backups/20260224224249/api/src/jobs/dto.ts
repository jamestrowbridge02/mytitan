...
export class BulkJobsDto {
  ...
  @IsString()
  @IsIn(['setStatus', 'assignTechnician', 'setLocation', 'addTag', 'removeTag', 'setDueDate', 'closeJobs'])
  operation!: 'setStatus' | 'assignTechnician' | 'setLocation' | 'addTag' | 'removeTag' | 'setDueDate' | 'closeJobs';
