...
const SUGGESTION_REASON_LABELS: Record<SuggestionReason, string> = {
...
const SUGGESTION_REASON_DISPLAY_LIMIT = 4;
...
function formatSuggestedLabel(startsAt: string, technicianName: string) {
...
function renderSuggestionReasons(reasons?: SuggestionReason[]) {
  if (!reasons?.length) {
    return null;
  }
  return (
                                        ...
                                        {(suggestState?.suggestions || []).slice(0, 3).map((suggestion) => (
                                          ...
                                          >
                                            <div style={{ fontSize: 11 }}>
                                              {formatSuggestedLabel(suggestion.startsAt, suggestion.technicianName)}
