...
export default function TradeAccountProfilePage() {
  ...
  const contactLine = `${account.contactName || "No contact"} | ${account.contactEmail || "No email"} | ${account.contactPhone || "No phone"}`;
  ...
  const whatsappHref = account.contactPhone
    ? `https://wa.me/${String(account.contactPhone).replace(/[^\d]/g, "")}`
    : "";
        ...
        <div>
          ...
          <EntitySection title="Contact" subtitle="Primary contact and account identifiers.">
            <div className="two-col">
              ...
              <div>
                ...
                {account.contactPhone ? (
                  <a href={whatsappHref}>{account.contactPhone}</a>
                ) : (
          ...
          <EntitySection title="Quick Actions" subtitle="Common next steps for this trade account.">
            <div style={{ display: "grid", gap: 10 }}>
              ...
              {account.contactPhone ? (
                <a className="button secondary" href={whatsappHref} target="_blank" rel="noreferrer noopener">
                  WhatsApp
                </a>
              ) : null}
              {account.contactEmail ? (
