  ...
  const readinessRows = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        detail: preferredProvider === "MANUAL" ? "Manual collection remains available until online payment setup is ready." : preferredProviderRow?.live ? "Online customer payments are marked live for this workspace." : "Customer payment setup still needs attention before online collection is ready.",
        href: "/dashboard/billing",
      ...
      },
      {
        ...
        state: customerPaymentReady ? "ready" : "needs_setup",
        detail: "Payment connection readiness is shown without exposing provider secrets.",
        href: "/dashboard/integrations",
