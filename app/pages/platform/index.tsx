...
const engineeringExcellenceScorecard = [
  ...
  },
  {
    ...
    missingEvidence: [
      'Independent security assessment: not attached.',
      'High/critical npm audit advisories require remediation or dated owner-approved exceptions before this can be marked complete.',
    ],
    ...
    remainingWeakness: 'Dependency and contract automation are not a formal external security certification, and current audit evidence requires review.',
    requiredFix: 'Remediate or document high/critical dependency advisories, then commission and attach independent security assessment evidence before claiming 10/10.',
